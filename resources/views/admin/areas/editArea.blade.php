            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">{{trans('home.edit_area')}}</li>
                    </ol>
                </div>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">{{trans('home.edit_area')}}</h4>
                </div>
                <div class="card-body p-4">
                    <div class="row">
                        <div class="col-lg-12">

                            <form method="POST" action="{{ url('admin/areas/' . $area->id) }}" enctype="multipart/form-data" data-toggle="validator">
                                @csrf
                                @method('PATCH')
                                ...
                                <div class="row">
                                    <div class="form-group col-4">
                                        ...
                                        <div class="form-check d-flex">
                                            <input type="checkbox" value="1" name="status" id="switch" {{($area->status == 1)? 'checked':''}} switch="success" checked />
