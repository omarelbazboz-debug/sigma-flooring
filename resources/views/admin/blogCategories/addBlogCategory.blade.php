            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">{{trans('home.add_blog_category')}}</li>
                    </ol>
                </div>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">{{trans('home.add_blog_category')}}</h4>
                </div>
                <div class="card-body p-4">
                    <div class="row">
                        <div class="col-lg-12">
                            <!-- End Page Header -->
                            <form method="POST" action="{{ route('blog-categories.store') }}" enctype="multipart/form-data" data-toggle="validator">
                                @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2 mb-3">
                                            ...
                                            <div class="form-check d-flex">
                                                <input type="checkbox" value="1" name="meta_robots" id="meta_robots" switch="success" checked />
