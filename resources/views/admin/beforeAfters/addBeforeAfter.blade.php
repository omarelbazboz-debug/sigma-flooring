...
<title>{{trans('home.add_beforeAfter')}}</title>
@section('content')
            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item"><a href="{{url('/admin/beforeAfters')}}">{{trans('home.beforeAfters')}}</a></li>
                        <li class="breadcrumb-item active">{{trans('home.add_beforeAfter')}}</li>
                    </ol>
                </div>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body p-4">
                    <div class="row">
                        <div class="col-lg-12">
                            <form method="POST" action="{{ route('beforeAfters.store') }}" enctype="multipart/form-data" data-toggle="validator">
                                @csrf

                                <div class="row">
                                    <div class="col-md-9 mb-3">
                                        <label class="">{{trans('home.before_img')}}</label>
                                        <input class="form-control" name="before_img" type="file" required>
                                    </div>
                                    <div class="col-md-9 mb-3">
                                        <label class="">{{trans('home.after_img')}}</label>
                                        <input class="form-control" name="after_img" type="file" required>
                                    </div>
                                ...
                                <div class="mt-4">
                                    ...
                                    <a href="{{url('/admin/beforeAfters')}}"><button type="button" class="btn btn-danger mr-1"><i class="icon-trash"></i> {{trans('home.cancel')}}</button></a>
                                </div>
