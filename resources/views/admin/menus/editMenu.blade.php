            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">{{trans('home.edit_menu')}}</li>
                    </ol>
                </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">{{trans('home.edit_menu')}}</h4>
                </div>
                ...
                <div class="card-body p-4">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <form method="POST" action="{{ url('admin/menus/' . $menu->id) }}" enctype="multipart/form-data" data-toggle="validator">
                                @csrf
                                @method('PATCH') 
                                <!-- Row-->
                                <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-check d-flex">
                                        <input type="checkbox" value="1" name="status" id="switch" switch="success" {{($menu->status == 1)? 'checked':''}} />
