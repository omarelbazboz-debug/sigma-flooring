                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a
                                    href="{{ url('/admin/careers') }}">{{ trans('home.head_headers') }}</a></li>
                            ...
                            <div class="col-lg-12">
                                <form method="POST" action="{{ url('admin/careers/' . $career->id) }}"
                                    ...
                                    <div class="row">
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <input class="form-control" name="title_en" type="text"
                                                placeholder="{{ trans('home.title_en') }}" value="{{ $career->title_en }}"
                                                required>
                                        </div>
                                        ...
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <input class="form-control" name="title_ar" type="text"
                                                placeholder="{{ trans('home.title_ar') }}" value="{{ $career->title_ar }}"
                                                required>
                                        </div>
                                        ...
                                        <div class="col-md-2 mb-3">
                                            ...
                                            <input type="text" class="form-control" name="icon"
                                                value="{{ old('icon', $career->icon ?? '') }}"
                                                placeholder="مثال: fas fa-cogs">
                                        </div>
                                        <div class="form-group col-md-6 ">
                                            <label for="text_en">{{ trans('home.text_en') }}</label>
                                            <textarea class="form-control ckeditor-classic" placeholder="{{ trans('home.text_en') }}" name="text_en">{!! $career->text_en !!}</textarea>
                                        </div>

                                        <div class="form-group col-md-6 ">
                                            <label for="text_ar">{{ trans('home.text_ar') }}</label>
                                            <textarea class="form-control ckeditor-classic" placeholder="{{ trans('home.text_ar') }}" name="text_ar">{!! $career->text_ar !!}</textarea>
                                        </div>

                                        <div class="col-md-6 mb-3">
                                            <label for="type">{{ trans('home.parent') }}</label>
                                            <select class="form-control" data-trigger name="type" required>
                                                <option value="statistics" {{ $career->type == 'statistics' ? 'selected' : '' }}>
                                                    {{ trans('home.statistics') }}</option>
                                                <option value="header" {{ $career->type == 'header' ? 'selected' : '' }}>
                                                    {{ trans('home.header') }}</option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input class="form-control" name="number" type="number"
                                                value="{{ $career->number }}" placeholder="{{ trans('home.number') }}">
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <div class="form-check d-flex">
                                            <input type="checkbox" value="1" name="status" id="switch"
                                                switch="success" {{ $career->status == 1 ? 'checked' : '' }} />
                                    ...
                                    <div class="mt-4">
                                        ...
                                        <a href="{{ url('/admin/careers') }}"><button type="button"
