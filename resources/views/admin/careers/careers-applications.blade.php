                            ...
                            <tbody>
                                @foreach($careerApplications as $careerApplication)
                                    <tr>
                                        ...
                                        <td><a href="{{asset('uploads/careers/pdfs/'.$careerApplication->file)}}" target="_blank"><span class="badge badge-success" style="color: black">{{trans('home.download_cv')}}</span></a></td>
                                    </tr>
                                @endforeach
