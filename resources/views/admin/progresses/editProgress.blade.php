        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body p-4">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <form method="POST" action="{{ url('admin/progresses/' . $progress->id) }}" enctype="multipart/form-data" data-toggle="validator">
                                @csrf
                                @method('PATCH')
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input class="form-control" name="text_ar" type="text"
                                            value="{{ $progress->text_ar }}" placeholder="{{ trans('home.text_ar') }}">
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label class="">{{ trans('home.text_en') }}</label>
                                        <input class="form-control" name="text_en" type="text"
                                            value="{{ $progress->text_en }}" placeholder="{{ trans('home.text_en') }}">
                                    </div>
                                    ...
                                    <div class="col-md-3 mb-3 mt-3">
                                        ...
                                        <input class="form-control" name="alt_img" type="text"
                                            value="{{ $progress->alt_img }}" placeholder="{{ trans('home.alt_img') }}" />
                                    </div>
                                    @if ($progress->image)
                                    <div class="form-group  col-md-2 m-2 mt-3">
                                        <img src="{{ url('\uploads\progress\source') }}\{{ $progress->image }}"
