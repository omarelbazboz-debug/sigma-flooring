                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <select class="form-control menu_type" data-trigger name="menu_type" required>
                                            ...
                                            <option value="teams" {{($menuItem->type == 'teams')?'selected':''}}>{{trans('home.teams') ?? 'Teams'}}</option>
                                            <option value="profile" {{($menuItem->type == 'profile')?'selected':''}}>{{trans('home.profile') ?? 'profile'}}</option>
