...
@section('content')
    <div class="container-fluid">
                ...
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">{{trans('home.offers_sliders')}}</li>
                        </ol>
                    </div>
        ...
        <a href="{{url('admin/offers-sliders/create')}}"><button class="btn ripple btn-primary col-md-2"><i class="fas fa-plus-circle"></i> {{trans('home.add')}}</button></a>
        <!-- End Page Header -->
                                    ...
                                    @foreach($sliders as $slider)
                                        <tr id="{{$slider->id}}">
                                            ...
                                            <td>
                                                <a>
                                                    @if($slider->image)
                                                        <img src="{{url('/uploads/sliders/offers-sliders/source')}}/{{$slider->image}}" width="70">
                                                    @else
                                            ...
                                            <td> 
                                                <a type="button" class="btn btn-info waves-effect waves-light " 
                                                    href="{{ route('offers-sliders.edit',$slider->id) }}" >{{__('home.edit')}}</a>
                                            </td>
                                            <td> 
