        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body p-4">
                    <div class="row">
                        <div class="col-lg-12">
                            <form method="POST" action="{{ url('admin/offers-sliders/'.$slider->id) }}" enctype="multipart/form-data" data-toggle="validator">
                                @csrf
                                @method('PATCH')
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group  col-md-12">
                                        <img src="{{url('\uploads\sliders\offers-sliders\SOURCE')}}\{{$slider->image}}" width="350" height="150">
                                    </div>
                                </div>
                                @endif
                        </div>
