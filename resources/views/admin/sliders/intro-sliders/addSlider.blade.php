        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body p-4">
                    <div class="row">
                        <div class="col-lg-12">
                            <form method="POST" action="{{ route('intro-sliders.store') }}" enctype="multipart/form-data" data-toggle="validator">
                                @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <label for="helperText" class="form-label font-size-13 text-muted">{{trans('home.lang')}}</label>
