            ...
            <div class="card">
                ...
                <div class="card-body p-4">
                    <div class="row">
                        <div class="col-lg-12">
                            <!-- End Page Header -->
                            <form method="POST" action="{{ route('home-sliders.store') }}" enctype="multipart/form-data" data-toggle="validator">
                                @csrf
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input class="form-control" name="title1" type="text" placeholder="{{trans('home.title1')}}">
                                    </div>
                                    <div class="col-md-6 mb-3">
