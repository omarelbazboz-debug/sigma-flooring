...
class HomeImageController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->hasFile("img_en")) {
            ...
            $img_path = public_path() . '/uploads/homeImages/source/';
            $img_path200 = public_path() . '/uploads/homeImages/resize200/';
            $img_path800 = public_path() . '/uploads/homeImages/resize800/';
            ...
            $path = public_path('uploads/homeImages/source/' . $fileName);
            $resize200 = public_path('uploads/homeImages/resize200/' . $fileName);
            $resize800 = public_path('uploads/homeImages/resize800/' . $fileName);
