...
class UserController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile("image")) {
            ...
            $path = public_path('uploads/users/source/' . $fileName);
            $resize200 = public_path('uploads/users/resize200/' . $fileName);
            $resize800 = public_path('uploads/users/resize800/' . $fileName);
