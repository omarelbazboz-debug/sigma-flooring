    ...
    public function edit($id)
    {
        ...
        if($menuItem){
            ...
            if($menuItem->type == 'category'){
                ...
                $values=Service::get();
            }elseif($menuItem->type == 'home' || $menuItem->type == 'about-us' || $menuItem->type == 'contact-us' || $menuItem->type =='board-of-members' || $menuItem->type == 'main-item' || $menuItem->type == 'projects' || $menuItem->type == 'services' || $menuItem->type == 'galleryImages' || $menuItem->type == 'galleryVideos'|| $menuItem->type == 'categories' || $menuItem->type == 'careers' || $menuItem->type == 'training'|| $menuItem->type == 'developers' || $menuItem->type == 'blogs'){
                $values=[];
