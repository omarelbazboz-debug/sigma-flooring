...
//            $path = public_path('uploads/careers/source/' . $fileName);
//            $resize200 = public_path('uploads/careers/resize200/' . $fileName);
//            $resize800 = public_path('uploads/careers/resize800/' . $fileName);
...
//            $mimearr = explode('/', $mime);
//
//            $img_path = public_path() . '/uploads/careers/source/';
//            $img_path200 = public_path() . '/uploads/careers/resize200/';
//            $img_path800 = public_path() . '/uploads/careers/resize800/';
//
//            if ($add->image != null) {
