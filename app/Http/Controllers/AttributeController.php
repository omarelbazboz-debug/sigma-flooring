...
class AttributeController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile("icon")) {
            ...
            $path = public_path('uploads/attribute/source/' . $fileName);
            $resize200 = public_path('uploads/attribute/resize200/' . $fileName);
            $resize800 = public_path('uploads/attribute/resize800/' . $fileName);
        ...
        if($request->all_categories){
            $categoryIds = Category::where('status',1)->get()->pluck('id')->toArray();
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->hasFile("icon")) {
            ...
            $img_path = public_path() . '/uploads/attribute/source/';
            $img_path200 = public_path() . '/uploads/attribute/resize200/';
            $img_path800 = public_path() . '/uploads/attribute/resize800/';
            if ($add->icon != null) {
